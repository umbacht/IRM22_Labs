...
int main()
{
    ...
    for(int i = 0; i<50; i++){
        ...
        int serial_read_return = serialport_read(serial_port, buffer, 6, 10000); // Needed to extend buffer to 6, otherwise would only return 2 bytes
        ...
        float voltage_reading_calibrated = voltage_reading_uncalibrated - quiescent_voltage;
